...
/*************************************************
Level:
Decides the strukture of the levels by taking in a vector with 
integers that represent the different elements. This is sent to 
the constructor with the size of every tile and the windows 
dimensions expressed in tiles. Every tile is asigned an element 
by the layout of the vector except for those that are 00, they 
are just "empty space" where the player can move. Level can 
provide pointers to the elements when the level is drawn or updated.
